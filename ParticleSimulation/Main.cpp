...
int main(int argc, char** argv)
{
		...
		//std::shared_ptr<cogs::SpatialHash<cogs::Particle>> spatialhash = std::make_shared<cogs::SpatialHash<cogs::Particle>>(4.0f);
		...
		particleSystem1.lock()->addComponent<cogs::ParticleSystem>(particleRenderer, 10000,
				5000.0f, 10.0f, 1.0f, 0.5f, true, false, gravity, cogs::Color::white,
